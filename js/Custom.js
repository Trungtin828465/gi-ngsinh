            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Chúc eiu một mùa giáng sinh vui vẻ bên anh. Cảm ơn em đã đồng hành trong khoảng thời gian này, mong rằng cả hai sẽ cũng nhau cố gắng đi cùng nhau thật dài nhé !!!",
                        ],
                        typeSpeed: 250,
                        startDelay: 500,
                        backSpeed: 50,
